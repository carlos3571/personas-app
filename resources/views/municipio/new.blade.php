  ...
  <div class="container">
   ...
   <form method="POST" action=" {{ route('municipios.store') }} ">
        ...
        <div class="mb-3">
            ...
            <div id="idHelp" class="form-text">Código Municipio</div>
        </div>
        
        <div class="mb-3">
            <label for="name" class="form-label">Municipio</label>
            <input type="text" required class="form-control" id="name" name="name" placeholder="Nombre Municipio." aria-describedby="nameHelp">
        </div>
